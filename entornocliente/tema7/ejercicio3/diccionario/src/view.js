...
export class View {
  ...
  actualizarListaPalabras(diccionario) {
    // Verifica que diccionario sea un array antes de intentar usar forEach
    if (Array.isArray(diccionario)) {
      ...
      console.error("Se esperaba un array, pero se recibió:", diccionario);
    }
  }
